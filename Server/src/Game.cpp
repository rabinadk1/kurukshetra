...
//	textures.load(Textures::grassTexture, "../Media/Textures/grass.png");
	...
	player.SetData(&textures.get(Textures::playerTexture), sf::Vector2u(3, 9), 0.3f, 150.0f, sf::Vector2f(1200, baseHeight));
	enemy.SetData(&textures.get(Textures::enemyTexture), sf::Vector2u(3, 9), 0.3f, 150.0f,sf::Vector2f(1200.f, baseHeight));
