...
#include "Enemy.h"
Enemy::Enemy(){}
void Enemy::SetData(sf::Texture *EnemyTexture, sf::Texture* bulletTexture, sf::Vector2u imageCount, float switchTime, float speed, sf::Vector2f position) {
...
void Enemy::HitCheck(sf::RectangleShape& bullet)
{
